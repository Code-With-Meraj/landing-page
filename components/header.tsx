    ...
    return (
        <div className="w-full">
            <header className="bg-white w-full">
                <nav className="max-w-[1440px] mx-auto px-4 py-3 flex flex-wrap md:flex-nowrap items-center justify-between gap-4">
                    ...
                    <div className="flex flex-wrap gap-4 items-center justify-end md:justify-between w-full md:w-auto">

                        <ul className="flex flex-wrap items-center font-medium gap-4 text-sm">
                            <li>
                                <Link className="hover:text-primary hover:underline" href="/">Menu</Link>
                            </li>
                            <li>
                                <Link className="hover:text-primary hover:underline" href="/">Orders</Link>
                            </li>
                        </ul>
                        ...
                        <div className="relative">
                            ...
                            {cart.length > 0 && (
                                <span className="absolute -top-3 -right-3 h-5 w-5 text-xs flex items-center justify-center rounded-full bg-primary text-white font-bold">
                                    {cart.length}
                                </span>
                            )}
                        </div>
                        ...
                        <Button size="sm" className="text-sm">Logout</Button>
                    </div>
                </nav>
            </header>
        </div>
